...
$(document).ready(function () {
    ...
    (function ($, window, document) {
        ...
        $(panelSelector).each(function () {
            ...
            $wrapper.collapse(collapseOpts).on('hide.bs.collapse', function () {
                $(this).prevAll('.panel-heading').find('i.ti-minus').removeClass('ti-minus').addClass('ti-plus');
            }).on('show.bs.collapse', function () {
                $(this).prevAll('.panel-heading').find('i.ti-plus').removeClass('ti-plus').addClass('ti-minus');
            });
        });
    ...
    /*js click show align box top < 1660px */
    $(".click-show-align-box").on("click", function () {
        $(".out-list-align").toggleClass("active");
    });
});
